...
public class activity_play_screen_multi  extends AppCompatActivity implements View.OnClickListener{
    ...
    public static int player1Score; //double para sa computation ng scorePercentageInteger
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.play_screen_multiplayer);
        ...
        player1Score = extras.getInt("player1Score"); //0 initial value
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (timeLeftInMillis == 0){
                    intent1 = new Intent(activity_play_screen_multi.this, play_screen_multiplayer1.class); //PUNTA KAY PLAYER 2 PAG UBOS NA ORAS NI PLAYER 1
                    keme = new Bundle();
                    ...
                    keme.putInt("score", 0);
                    keme.putInt("player1Score", player1Score); //dalin nya ung score ni player sa susunod
                    keme.putInt("player2Score", 0);
                    ...
                    if (!answered){
                        if (choiceaSelected > 0){
                            ...
                            Toast.makeText(activity_play_screen_multi.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else{
                        nextQuestion();
