...
public class play_screen_multiplayer1 extends AppCompatActivity implements View.OnClickListener{
    ...
    public static int player1Score, player2Score; //double para sa computation ng scorePercentageInteger
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.play_screen_multiplayer1);
        ...
        player2Score = extras.getInt("player2Score"); //inital value 0
            ...
            public void onClick(View v) {
                if (timeLeftInMillis == 0){
                    if (player_number.numberOfPlayersChosen == 2){
                        intent1 = new Intent(play_screen_multiplayer1.this, WinScreenMulti.class); //PUNTA KAY PLAYER 2 PAG UBOS NA ORAS NI PLAYER 1
                        keme = new Bundle();
                        keme.putInt("player1Score", player1Score);
                        keme.putInt("player2Score", player2Score); //si winscreen ang magmamana nito
                        intent1.putExtras(keme);
                        startActivity(intent1);
                    } else {
                        intent1 = new Intent(play_screen_multiplayer1.this, play_screen_multiplayer2.class); //PUNTA KAY PLAYER 2 PAG UBOS NA ORAS NI PLAYER 1
                        keme = new Bundle();
                        //reset all values and then passed it to next playerscreen multi
                        keme.putString("category", category);
                        keme.putString("gameMode", "Multiplayer");
                        keme.putInt("COUNTDOWN_IN_MILLIS", 60000);
                        keme.putInt("EXTRA_COUNT", 0);
                        keme.putInt("score", 0);
                        keme.putInt("player1Score", player1Score);
                        keme.putInt("player2Score", player2Score);
                        keme.putInt("player3Score", 0);
                        intent1.putExtras(keme);
                        startActivity(intent1);
                    }
                }
                    ...
                    if (!answered){
                        if (choiceaSelected > 0){
                            ...
                            Toast.makeText(play_screen_multiplayer1.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else{
                        nextQuestion();
