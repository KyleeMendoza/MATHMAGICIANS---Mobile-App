...
public class play_screen_multiplayer2 extends AppCompatActivity implements View.OnClickListener{
    ...
    public static int player1Score, player2Score, player3Score; //double para sa computation ng scorePercentageInteger
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.play_screen_multiplayer2);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (timeLeftInMillis == 0){
                    if (player_number.numberOfPlayersChosen == 3){
                        intent1 = new Intent(play_screen_multiplayer2.this, WinScreenMulti.class); //PUNTA KAY PLAYER 2 PAG UBOS NA ORAS NI PLAYER 1
                        keme = new Bundle();
                        keme.putInt("player1Score", player1Score);
                        keme.putInt("player2Score", player2Score);
                        keme.putInt("player3Score", player3Score); //si winscreen ang magmamana nito
                        intent1.putExtras(keme);
                        startActivity(intent1);
                    } else {
                        intent1 = new Intent(play_screen_multiplayer2.this, play_screen_multiplayer3.class); //PUNTA KAY PLAYER 2 PAG UBOS NA ORAS NI PLAYER 1
                        keme = new Bundle();
                    ...
                    if (!answered){
                        if (choiceaSelected > 0){
                            ...
                            Toast.makeText(play_screen_multiplayer2.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else{
                        nextQuestion();
