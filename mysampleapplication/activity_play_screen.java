...
public class activity_play_screen extends AppCompatActivity implements View.OnClickListener{
    ...
    public static double questionCounterDouble;
    ...
    Intent intent1; //win single
    Intent intent2; //win multi
    String gameMode;
    String category;

    public static int score;
    public static double scoreDoubleType; //double para sa computation ng scorePercentageInteger
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (timeLeftInMillis == 0){
                    intent1 = new Intent(activity_play_screen.this, WinScreenSingle.class);
...
//                    }
//                    else {
//                        intent2 = new Intent(activity_play_screen.this, WinScreenMulti.class);
...
//                    }
                    ...
                    if (!answered){
                        if (choiceaSelected > 0){
                            ...
                            Toast.makeText(activity_play_screen.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else{
                        nextQuestion();
    ...
    public void nextQuestion() {
        ...
        if (EXTRA_COUNT < questionCountTotal) {
            ...
            EXTRA_COUNT++;
            questionCounterDouble = EXTRA_COUNT;
...
//        }
    ...
    //YUNG MGA LINES WARNING LANG YAN DI ERROR
    @Override
    public void onClick(View v) {
